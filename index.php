 ...
 * UNTUK TUJUAN TERTENTU DAN PELANGGARAN. DALAM KEADAAN THE
 ...
 * ------------------------------------------------- --------------
 *
 * Anda dapat memuat konfigurasi yang berbeda tergantung pada Anda
 * Lingkungan saat ini. Pengaturan lingkungan juga mempengaruhi
 * Hal-hal seperti penebangan dan pelaporan kesalahan.
 *
 * Ini dapat diatur untuk apa-apa, tapi penggunaan default adalah:
 *
 * pengembangan
 * pengujian
 *     produksi
 *
 * CATATAN: Jika Anda mengubah ini, juga mengubah error_reporting () kode di bawah
 */
